...
key = "some optional key contributed to the final hash"
rec = o.opaque_init_srv(pwd, extra, key)
print("usrSession")
pub, sec = o.opaque_session_usr_start(pwd)
print("srvSession")
resp, sk_s = o.opaque_session_srv(pub, rec)
print("usrSessionEnd")
sk_u, extra = o.opaque_session_usr_finish(pwd, resp, sec, key)
...
rec = o.opaque_private_init_usr_respond(pwd, r, pub_s, extra, key)
